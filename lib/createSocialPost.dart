...
class CreatePartyPost extends StatefulWidget {
  @override
  _CreatePartyPostState createState() => _CreatePartyPostState();
}

class _CreatePartyPostState extends State<CreatePartyPost> {
   @override
  void initState() {
    super.initState();
    state = AppState.free;
