...
//  String postId;
  ...
  getPostInfo() async{
    DocumentSnapshot doc= await Firestore.instance.collection('profPosts').document(widget.postId).get();
                        ...
                        GestureDetector(
                          onTap: () async{
                            if(liked==false){
                              ...
                              Firestore.instance.collection('profPosts').document(widget.postId).updateData({
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: liked==false?Colors.grey[100]:Color(0xFF76c2c0)),
                            child: Column(
                              children: <Widget>[
                                SizedBox(
                                  height: screenH(5),
