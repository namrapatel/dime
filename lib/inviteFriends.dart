      ...
      //backgroundColor: Color(0xFFECE9E4),
        body: Column(
          children: <Widget>[
            ...
            Center(
              child: Text("Invite Friends", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25)),
            ),
            Padding(
              padding: const EdgeInsets.fromLTRB(70, 10, 70, 0),
              child: Center(
                child: Text("Invite your friends to the Dime community to spread the word and form the app ecosystem.", textAlign: TextAlign.center,),
              ),
            ),
            SizedBox(
              height: screenH(30),
