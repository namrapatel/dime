 ...
 _textMe() async {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _myListView(BuildContext context) {
            ...
            final titles = ['tech_community', 'business',];

      final icons = [MaterialCommunityIcons.brain, MaterialCommunityIcons.account_tie,];
                ...
                subtitle: Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Icon(Icons.people),
                      SizedBox(width: 5,),
                      Text("203", style: TextStyle(color: Colors.black),),
                      FlatButton(
